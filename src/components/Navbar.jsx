              ...
              {isPending ? (
                ...
                <Link
                  ...
                  className={`text-sm font-medium transition hover:text-violet-300 ${
                    pathname === "/auth/signin" ? "text-white" : "text-violet-400"
                  }`}
                >
                  Sign In
                </Link>
          ...
          <div className="space-y-3 px-4 py-6">
            ...
            <div className="border-t border-white/10 pt-4">
              <div className="flex flex-col gap-3">
                {isPending ? (
                  <span className="text-sm text-gray-400 px-4">Loading...</span>
                ) : user ? (
                  <>
                    <span className="text-gray-300 px-4">Hi, {user.name}!</span>
                    <Button 
                  ...
                  <Link
                    ...
                    className={`rounded-xl px-4 py-3 text-base font-medium transition ${
                      pathname === "/auth/signin" ? "bg-gradient-to-r from-violet-600 to-fuchsia-500 text-white" : "text-violet-400 hover:bg-white/5"
                    }`}
                    onClick={() => setIsMenuOpen(false)}
                  >
                    Sign In
